		...
		<div>
			...
			<div className="container d-flex justify-content-center text-left">
				<ul className="list-group w-50">
					...
					{listaTareas.map((item, id) => <li class="list-group-item" key={id}>{item}<button type="button" className="btn btn-info float-end nuevoBoton" onClick={() => eliminarTareas(id)}>X</button> </li>)}
